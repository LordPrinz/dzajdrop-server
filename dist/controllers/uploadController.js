...
var uploadToDiscordHandler = function (path, fileName) { return __awaiter(void 0, void 0, void 0, function () {
    var discordRes;
...
var uploadController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var uploadBytesLimit, freeSpace, busboy, approximateFileSize, tempFolderPath, totalBytesReceived, fileStream, fileIndex, calculateProgress, streamResponse, sendProgressResponse;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                if (freeSpace - uploadBytesLimit <= uploadBytesLimit) {
                    return [2 /*return*/, res.status(413).send("Insufficient storage space")];
                }
                busboy = req.busboy;
                if (!busboy) {
