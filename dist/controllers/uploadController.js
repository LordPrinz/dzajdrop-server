...
var uploadController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var uploadBytesLimit, freeSpace, busboy, avaliableBot, messageIds, originalFileSize, uploadToDiscordHandler, approximateFileSize, tempFolderPath, totalBytesReceived, fileStream, fileIndex, calculateProgress, sendProgressResponse;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                uploadBytesLimit = config_1.config.uploadBytesLimit;
                return [4 /*yield*/, utils_1.getFreeSpace()];
            case 1:
                freeSpace = _a.sent();
                if (freeSpace - uploadBytesLimit <= uploadBytesLimit) {
                    return [2 /*return*/, utils_1.sendResponse(res, { status: 413, data: "Insufficient storage space" })];
                }
                busboy = req.busboy;
                if (!busboy) {
                    return [2 /*return*/, utils_1.sendResponse(res, { status: 400, data: "No file provided" })];
                }
                avaliableBot = BotManager_1.botManager.getAvailableBot(0);
                ...
                sendProgressResponse = function () {
                    ...
                    utils_1.streamResponse(res, { progress: progress });
                };
